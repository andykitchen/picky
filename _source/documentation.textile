...
h4(#indexes-categories-similarity). Option weights
...
h4(#indexes-categories-qualifiers). Option qualifiers (categorizing)

h4(#indexes-categories-from). Option from

h4(#indexes-categories-keyformat). Option key_format

h4(#indexes-categories-partial). Option source
